package com.jike.wlw.service.product.serverSubscription.subscribe.privatization;
...
import com.jike.wlw.service.product.serverSubscription.subscribe.BaseSubscribeRelationService;
...
public interface PrivateSubscribeRelationService extends BaseSubscribeRelationService {
    ...
    @ResponseBody
    String createSubscribeRelation(@ApiParam(required = true, value = "租户") @RequestParam(value = "tenantId") String tenantId,
