...
public interface SourceService {
    ...
    @ResponseBody
    Source get(@ApiParam(required = true, value = "租户编号") @RequestParam(value = "tenantId") String tenantId, @ApiParam(required = true, value = "uuid") @RequestParam(value = "uuid") String uuid) throws BusinessException;

    @ApiOperation(value = "新建资源")
    @RequestMapping(value = "/create", method = RequestMethod.POST)
    @ResponseBody
    void create(@ApiParam(required = true, value = "租户编号") @RequestParam(value = "tenantId") String tenantId, @ApiParam(required = true, value = "新建资源请求参数") @RequestBody Source createRq, @ApiParam(required = true, value = "操作人") @RequestParam(value = "operator") String operator) throws BusinessException;

    @ApiOperation(value = "编辑资源")
    @RequestMapping(value = "/modify", method = RequestMethod.POST)
    @ResponseBody
    void modify(@ApiParam(required = true, value = "租户编号") @RequestParam(value = "tenantId") String tenantId, @ApiParam(required = true, value = "uuid") @RequestParam(value = "uuid") String uuid, @ApiParam(required = true, value = "编辑资源请求参数") @RequestBody Source modifyRq,
    ...
    @ResponseBody
    ActionResult checkConnecting(@ApiParam(required = true, value = "租户编号") @RequestParam(value = "tenantId") String tenantId, @ApiParam(required = true, value = "uuid") @RequestParam(value = "uuid") String uuid) throws BusinessException;

    @ApiOperation(value = "根据查询条件查询资源")
    @RequestMapping(value = "/query", method = RequestMethod.POST)
    @ResponseBody
    PagingResult<Source> query(@ApiParam(required = true, value = "租户编号") @RequestParam(value = "tenantId") String tenantId, @ApiParam(required = true, value = "查询条件") @RequestBody SourceFilter filter) throws BusinessException;
}
