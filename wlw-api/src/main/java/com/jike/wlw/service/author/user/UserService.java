...
public interface UserService {
    ...
    @RequestMapping(value = "service/user/get", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "service/user/modify", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "service/user/query", method = RequestMethod.POST)
    @ResponseBody
