package com.jike.wlw.service.equipment.privatization;
...
@Api(tags = "私有化设备服务")
@RequestMapping(value = "service/equipment/private", produces = "application/json;charset=utf-8")
public interface PrivateEquipmentService extends BaseEquipmentService {
