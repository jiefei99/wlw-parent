package com.jike.wlw.service.serverSubscription.consumerGroup.ali;
...
public interface AliConsumerGroupService extends BaseConsumerGroupService {
    ...
    @ResponseBody
    void resetPosition(@ApiParam(required = false, value = "租户") @RequestParam(value = "tenantId") String tenantId,
    ...
    @ResponseBody
    ConsumerGroup get(@ApiParam(required = false, value = "租户") @RequestParam(value = "tenantId") String tenantId,
                      @ApiParam(required = true, value = "消费组Id") @RequestParam(value = "groupId") String groupId,
                      @ApiParam(required = false, value = "实例Id") @RequestParam(value = "iotInstanceId") String iotInstanceId) throws BusinessException;
    ...
    @ResponseBody
    PagingResult<ConsumerGroupVO> query(@ApiParam(required = false, value = "租户") @RequestParam(value = "tenantId") String tenantId,
