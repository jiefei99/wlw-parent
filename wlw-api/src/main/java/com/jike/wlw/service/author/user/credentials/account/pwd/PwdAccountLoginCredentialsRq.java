...
@Setter
@ApiModel("密码账号登录凭证")
public class PwdAccountLoginCredentialsRq extends LoginCredentials {
    ...
    public PwdAccountLoginCredentialsRq() {
        this.setLoginMode(LoginMode.PWD);
    }

    public PwdAccountLoginCredentialsRq(LoginClient loginClient, UserType userType, String loginId, String password) {
        this.setLoginMode(LoginMode.PWD);
