package com.jike.wlw.core.product.serverSubscription.subscribe.ali;
...
import com.jike.wlw.core.product.serverSubscription.subscribe.ali.iot.SubscribeRelationManager;
...
import com.jike.wlw.service.product.serverSubscription.subscribe.ali.AliSubscribeRelationService;
...
public class AliSubscribeRelationServiceImpl extends BaseService implements AliSubscribeRelationService {
    ...
    @Override
    public String createSubscribeRelation(String tenantId, ConsumerGroupSubscribeCreateRq createRq, String operator) {
        try {
